...
def main():
    ...
    if args.do_train:
        ...
        if args.local_rank in [-1, 0]:
            ...
            _, eval_score = evaluate(args, model, eval_dataset, prefix=global_step)
            _, test_score = evaluate(args, model, test_dataset, prefix=global_step)
            saved_info['eval_result'] = {'val': eval_score, 'test1': test_score}
